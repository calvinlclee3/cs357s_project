...
module TLPLIC(	// @[generators/rocket-chip/src/main/scala/devices/tilelink/Plic.scala:132:9]
  ...
  `ifndef SYNTHESIS	// @[generators/rocket-chip/src/main/scala/devices/tilelink/Plic.scala:251:11]
    ...
    wire [1:0] _GEN_1 = {completer_1, completer_0};	// @[generators/rocket-chip/src/main/scala/devices/tilelink/Plic.scala:268:23, :301:35, generators/rocket-chip/src/main/scala/tilelink/RegisterRouter.scala:87:24]
  ...
  wire        claiming = claimer_0 & maxDevs_0 | claimer_1 & maxDevs_1;	// @[generators/rocket-chip/src/main/scala/devices/tilelink/Plic.scala:185:22, :252:{49,92}, generators/rocket-chip/src/main/scala/tilelink/RegisterRouter.scala:87:24]
  always @(posedge clock) begin	// @[generators/rocket-chip/src/main/scala/devices/tilelink/Plic.scala:132:9]
    ...
    else if (claiming | _gateways_gateway_io_plic_valid)	// @[generators/rocket-chip/src/main/scala/devices/tilelink/Plic.scala:160:27, :252:92, :257:15]
      pending_0 <= ~claiming;	// @[generators/rocket-chip/src/main/scala/devices/tilelink/Plic.scala:172:26, :252:92, :257:34]
  end // always @(posedge)
